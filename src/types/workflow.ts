...
export const MODEL_MODES = ['inherit', 'auto', 'lightest', 'strongest'] as const;
...
export interface WorkflowGateConfig {
  ...
  readonly human?: boolean | { readonly script: string };
...
export const PLANNING_DEFAULTS: PlanningRestrictions = {
  maxSubsteps: 7,
  maxPlanAttempts: 3,
  allowParallel: false,
...
export function resolvePlanningRestrictions(step: Step): PlanningRestrictions {
  return {
