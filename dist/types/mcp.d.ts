...
import type { StepCollectAction, StepCompleteAction, TerminalWorkflowStatus, WorkflowStatus } from './enums.js';
...
export type StepBeginOutput = StepBeginRegular | StepBeginDelegation | StepBeginParallel | StepBeginPlanning;
export interface StepBeginRegular {
    ...
    readonly gate?: {
        ...
        readonly human: boolean | 'conditional';
    };
...
export type WorkflowValidateDynamicOutput = WorkflowValidateDynamicSuccess | WorkflowValidateDynamicError;
...
export type WorkflowInvokeDynamicOutput = WorkflowInvokeDynamicSuccess | WorkflowInvokeDynamicError;
export interface StepBeginDynamicInput {
    readonly parent_workflow: WorkflowName;
    readonly parent_step: StepName;
    readonly step: StepName;
}
export type StepBeginDynamicOutput = StepBeginOutput | {
    readonly error: string;
};
...
export type StepCollectResultDynamicOutput = StepCollectResultOutput | {
    readonly error: string;
};
...
export type StepCompleteDynamicOutput = StepCompleteOutput | {
    readonly error: string;
};
...
export type WorkflowFinalizeDynamicOutput = WorkflowFinalizeDynamicSuccess | {
    readonly error: string;
};
...
export type AgentNotesWriteOutput = AgentNotesWriteSuccess | {
    readonly error: string;
};
...
export type AgentNotesSearchOutput = AgentNotesSearchSuccess | {
    readonly error: string;
};
...
export interface StepCompleteBlocked {
    ...
    readonly step: string;
    readonly blocked_reason: 'all_branches_failed' | 'missing_branches' | 'partial_branches_failed' | 'non_parallel_failed';
    readonly failed_branches: readonly unknown[];
}
export type StepCompleteOutput = StepCompleteSuccess | StepCompleteValidationError | StepCompleteBlocked;
